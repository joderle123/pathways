...
const IMPULSE = [
  ...
  { typ: 'konzept', titel: 'Therapeutische Allianz (Bordin 1979)', text: 'Drei Komponenten: (1) Bond — emotionale Verbindung, (2) Goals — Einigung über Ziele, (3) Tasks — Einigung über Methoden. SRS misst die Allianz. Wenn SRS < 25: Allianz-Bruch möglich. Ansprechen, nicht ignorieren.', reflexion: 'Meta-Analyse (Horvath 2011): Allianz erklärt 7-8% der Varianz im Outcome — mehr als jede spezifische Technik. Die Allianz zu pflegen ist kein "Soft Skill" — es ist der wichtigste Wirkfaktor.', xp: 10 },
];
